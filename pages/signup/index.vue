    ...
    <section class="bg-white dark:bg-gray-900">
      <div class="grid lg:min-h-screen lg:grid-cols-12">
        ...
        >
          <img
            alt="Night"
            src="https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Ftse1.mm.bing.net%2Fth%3Fid%3DOIP.OczrAEZrfogDEBF5lZwUkgHaJQ%26pid%3DApi&f=1&ipt=2798fe346f33607f45cb96aea87b85e74e032147b1a4ac5389bd85c38ab87740&ipo=images"
            class="absolute inset-0 h-full w-full object-cover opacity-50"
          />

          <div class="absolute bottom-[200px] hidden lg:relative lg:block lg:p-12">
            <a class="block text-[#0CDE77]" href="/">
            ...
            >
              Welcome to <span class="text-[#0CDE77]">iGapple</span>
            </h2>
