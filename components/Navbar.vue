      ...
      <div class="mx-auto max-w-screen-xl px-4 py-4 sm:px-6 lg:px-8">
        <div class="flex h-16 items-center justify-between">
          <div class="flex-1 md:flex md:items-center md:gap-3">
            <nuxt-link class="block text-[#0CDE77]" to="/">
          ...
          <div class="md:flex md:items-center md:gap-12">
            ...
            <div class="flex items-center gap-4">
              <div class="sm:flex sm:gap-4">
                <nuxt-link
                  class="rounded-md bg-[#0CDE77] outline outline-2 px-5 py-2.5 text-sm font-medium text-black hover:text-white"
                  to="/signin"
                >
                  Sign In
                </nuxt-link>
                ...
                <div class="hidden sm:flex">
                  <nuxt-link
                    class="rounded-md bg-black outline outline-2 px-5 py-2.5 text-sm font-medium text-[#0CDE77] hover:text-white"
                    to="/signup"
                  >
                    Sign Up
                  </nuxt-link>
